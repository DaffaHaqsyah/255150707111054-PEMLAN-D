...
public class MainAritmatika {
    ...
    public static void main(String[] args) {
        ...
        // memanggil method hitungPembagian (non-static, parameter String)
        System.out.print("masukkan nilai 1 : ");
        String strVal1 = in.next();

        System.out.print("masukkan nilai 2 : ");
        String strVal2 = in.next();

        double hasilBagi = a.hitungPembagian(strVal1, strVal2);
