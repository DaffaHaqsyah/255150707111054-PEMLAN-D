...
public class SoalA {
    ...
    public static void main(String[] args) {
        ...
        cetakTabel("A", "Tinggi Ascending (Menaik)", timA);

        // --- TIM A DESCENDING ---
        Collections.sort(timA, (a, b) -> b.tinggiBadan - a.tinggiBadan);
        cetakTabel("A", "Tinggi Descending (Menurun)", timA);

        // --- TIM B ASCENDING ---
        Collections.sort(timB, (a, b) -> a.tinggiBadan - b.tinggiBadan);
        cetakTabel("B", "Tinggi Ascending (Menaik)", timB);

        // --- TIM B DESCENDING ---
        Collections.sort(timB, (a, b) -> b.tinggiBadan - a.tinggiBadan);
        cetakTabel("B", "Tinggi Descending (Menurun)", timB);
    }
}